...
public class FilterItems {
    ...
    private final List<String> loreList = Arrays.asList(GRAY + "Schuppenr\u00fcstung", GRAY + "Plattenr\u00fcstung", GRAY + "Kettenr\u00fcstung", GRAY + "Dolch",
            GRAY + "Katana", GRAY + "Langschwert", GRAY + "Ritterschwert", GRAY + "Rapier", BLUE + "Questitem");
